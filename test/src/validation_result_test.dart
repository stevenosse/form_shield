...
void main() {
  group('ValidationResult', () {
    ...
    test('toString returns a formatted string representation', () {
      ...
      expect(successResult.toString(), 'ValidationResult(isValid: true, errorMessage: null)');
      expect(errorResult.toString(), 'ValidationResult(isValid: false, errorMessage: Error message)');
    });
  });
}